...
// static long getLongValue( const char * pValue, int base = 10 )
// {
//     int l = strlen( pValue );
//     int m = 1;
//     char ch = *( pValue + l - 1 );
...
//         m = 1024;
//     }
//     return strtol(pValue, (char **)NULL, base) * m;
// }
...
// static long getLongValue( const XmlNode * pNode, const char * pTag,
//                           long min, long max, long def, int base = 10 )
// {
//     const char * pValue = pNode->getChildValue( pTag );
//     long val;
//     if ( pValue )
                                      ...
                                      int setDebugLevel )
{
    ...
    {
        long rollingSize = 1024 * 1024 * 1024;
                                     ...
                                     int setDebugLevel )
{
    ...
    long rollSize =
        getLongValue( pNode, "rollingSize", 1024*1024,
                      INT_MAX, 1024*10240 );
    logSource.setErrorLogRollingSize( rollSize );
    if ( setDebugLevel )
    {
...
int HttpServerBuilder::initAdmin(  const XmlNode * pNode )
{
    ...
    snprintf( achPHPBin, 4096, "LSWS_EDITION=LiteSpeed Web Server/%s/%s",
              "Open",
              VERSION  );
