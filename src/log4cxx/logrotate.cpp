...
int LogRotate::roll(Appender * pAppender, uid_t uid, gid_t gid, long rollingSize )
{
    int ret = 0;
...
int LogRotate::testRolling( Appender * pAppender, long rollingSize, uid_t uid, gid_t gid )
{
    int ret = 0;
    if ( rollingSize <= 0 )
        return ret;
