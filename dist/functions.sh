...
installation()
{
    ...
    util_mkdir "$SDIR_OWN" $DIR_MOD admin bin docs fcgi-bin php lib logs docs/css docs/img admin/logs add-ons share share/autoindex admin/fcgi-bin admin/html.$VERSION admin/misc 
