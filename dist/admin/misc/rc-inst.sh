...
if [ -d "$INIT_BASE_DIR/runlevel/default" ]; then
	ln -fs ../init.d/lsws $INIT_BASE_DIR/runlevel/default/S88lsws
	ln -fs ../init.d/lsws $INIT_BASE_DIR/runlevel/default/K12lsws
fi


if [ -d "$INIT_BASE_DIR/rc2.d" ]; then
	ln -fs ../init.d/lsws $INIT_BASE_DIR/rc2.d/S88lsws
	ln -fs ../init.d/lsws $INIT_BASE_DIR/rc2.d/K12lsws
fi

if [ -d "$INIT_BASE_DIR/rc3.d" ]; then
ln -fs ../init.d/lsws $INIT_BASE_DIR/rc3.d/S88lsws
ln -fs ../init.d/lsws $INIT_BASE_DIR/rc3.d/K12lsws
fi

if [ -d "$INIT_BASE_DIR/rc5.d" ]; then
ln -fs ../init.d/lsws $INIT_BASE_DIR/rc5.d/S88lsws
ln -fs ../init.d/lsws $INIT_BASE_DIR/rc5.d/K12lsws
fi

if [ -d "$INIT_BASE_DIR/rc0.d" ]; then
ln -fs ../init.d/lsws $INIT_BASE_DIR/rc0.d/K12lsws
fi

if [ -d "$INIT_BASE_DIR/rc1.d" ]; then
ln -fs ../init.d/lsws $INIT_BASE_DIR/rc1.d/K12lsws
fi

if [ -d "$INIT_BASE_DIR/rc6.d" ]; then
ln -fs ../init.d/lsws $INIT_BASE_DIR/rc6.d/K12lsws
fi
