...
<table width="100%" class="xtbl" border="0" cellpadding="5" cellspacing="1">
    ...
    <tr class="xtbl_value">
            ...
            ?>
            <input class="xtbl_value" type="text" name="path_env" size="60" value="<?php echo $options->GetValue('ExtraPathEnv');?>"></td>
    </tr>
    <tr class="xtbl_value">
            ...
            ?>
            <input class="xtbl_value" type="text" name="installPath" size="60" value="<?php echo $options->GetValue('InstallPath');?>"></td>
    </tr>
    <tr class="xtbl_value">
            <td class="xtbl_label">Configure Parameters</td>
			<td class="icon">
				<img class="xtip-hover-autoFix503" src="/static/images/icons/info.gif">
				<div id="xtip-note-autoFix503" class="snp-mouseoffset notedefault">
    ...
    <td>
    	...
    	?>
    	<input type="checkbox" name="addonMailHeader" <? if ($options->GetValue('AddOnMailHeader')) echo 'CHECKED' ?>> <a href="http://choon.net/php-mail-header.php">PHP Mail Header Patch</a> (Identifies Mail Source) <br>
        <input type="checkbox" name="addonAPC" <? if ($options->GetValue('AddOnAPC')) echo 'CHECKED' ?>> <a href="http://pecl.php.net/package/APC">APC</a> (Opcode Cache)<br>
        <input type="checkbox" name="addonEAccelerator" <? if ($options->GetValue('AddOnEAccelerator')) echo 'CHECKED' ?>> <a href="http://www.eaccelerator.net">eAccelerator</a> (Opcode Cache)<br>
        <input type="checkbox" name="addonXCache" <? if ($options->GetValue('AddOnXCache')) echo 'CHECKED' ?>> <a href="http://xcache.lighttpd.net/">XCache</a>  (Opcode Cache)<br>
		<input type="checkbox" name="addonMemCache" <? if ($options->GetValue('AddOnMemCache')) echo 'CHECKED' ?>> <a href="http://pecl.php.net/package/memcache">pecl/memcache</a> (memcached extension)<br> 
    </td>
    </tr>
</table>
<center>
